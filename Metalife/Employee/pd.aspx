<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="pd.aspx.vb" Inherits="Metalife.pd" %>
  ...
  <div id="cols" class="box">
    ...
    <div id="aside" class="box">
      ...
      <ul class="box">
        ...
        <li id="submenu-active"><a href="pd.aspx">Patients Discharge</a></li>
