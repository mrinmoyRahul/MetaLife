Public Class pd
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If ob.ds.Tables(0).Rows.Count <> 0 Then
            For j = 0 To ob.ds.Tables(0).Rows.Count - 1
                ...
                k = New TableCell
                k.Text = ob.ds.Tables(0).Rows(j)("LastName")
                r.Cells.Add(k)
        ...
        If ob.ds1.Tables(0).Rows.Count <> 0 Then
            For j = 0 To ob.ds1.Tables(0).Rows.Count - 1
                ...
                c = New TableCell
                c.Text = ob.ds1.Tables(0).Rows(j)("FirstName")
                r.Cells.Add(c)

                k = New TableCell
                k.Text = ob.ds1.Tables(0).Rows(j)("LastName")
                r.Cells.Add(k)
    ...
    Protected Sub RemButton_Click(ByVal sender As Object, ByVal e As System.EventArgs)
        ...
        ob.cmd.CommandText = "insert into DischargedPatients(FirstName,LastName,Gender,Address,Email,ContactNumber,WardName,BedNumber) values('" & ob.ds.Tables(0).Rows(0)(1) & "','" & ob.ds.Tables(0).Rows(0)(2) & "','" & ob.ds.Tables(0).Rows(0)(3) & "','" & ob.ds.Tables(0).Rows(0)(4) & "','" & ob.ds.Tables(0).Rows(0)(5) & "','" & ob.ds.Tables(0).Rows(0)(6) & "','" & ob.ds.Tables(0).Rows(0)(7) & "','" & ob.ds.Tables(0).Rows(0)(8) & "')"
